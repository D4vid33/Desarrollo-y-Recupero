    ...
    const ConfigView = ({
        ...
        <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50">
            <div className="w-full max-w-xl bg-white rounded-[2.5rem] shadow-2xl p-8 border border-gray-100 animate-slide-up text-center">
                ...
                <h1 className="text-2xl font-black text-slate-900 mb-1 uppercase tracking-tighter">Gestion por Lotes</h1>
                <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-8">CRM DataFix</p>
        ...
        <div className="max-w-5xl mx-auto p-4 pb-32 animate-slide-up">
            ...
            <section className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white rounded-[2rem] p-5 shadow-sm border border-gray-100"><p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Gestiones de hoy</p><p className="text-3xl font-black text-slate-900">{resumenEjecutivo.gestionesHoy}</p></div>
                </div>
            </section>
